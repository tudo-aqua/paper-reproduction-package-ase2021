...
plot 'ABC.csv' using 1:2  with lines lt 1 lw 4 ti 'ABC', \
 'CVC5.csv' using 1:2 with lines lt 3 lw 4 ti 'CVC4', \
 ...
 'MULTI_NO_UNSAT_CHECK.csv' using 1:2 with lines lw 4 lt rgb "black" dt 9 ti 'CvcSeqEval', \
  'FASTEST.csv' using 1:2 with lines lt rgb "black" lw 4 dt 5 ti 'Earliest', \
   ...
   'JEARLY.csv' using 1:2 with lines lt rgb "slategray" lw 4 dt 1 ti 'JEarliest', \
'JEARLYTRUSTED.csv' using 1:2 with lines lt rgb "slategray" lw 4 dt 2 ti 'JEarliestTrusted', \
